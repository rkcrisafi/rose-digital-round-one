...
Welcome to the code test. Take a minute and read through the relevant docs below (build scripts, linting, etc...).

Your task is to build a mini-app. The work you'll be doing is similar on a small scale to what we do every day. Writing components, creating reusable components, styling components, managing state, calling APIs and handling the results, etc. What we're looking for is your ability to build this functionality using the common best practices for web development. We'll be looking at how you structure your code, your HTML/CSS, the syntax you use, your unit tests (if any) and the way you accomplish the goal of building this working mini app.
